...
if(state === "new") {
    ...
    document.querySelector(".termin").innerHTML = `
        <div style="line-height: 1.6;">
            Welcome to the Krypton Terminal type <code class="command">help</code> for available commands and keybindings or<br> <code class="command">-h <mark class="codeMark">command</mark></code> for a commands usage.
        </div>
    ...
    if (e.key === "Enter") {
        ...
        if(command.textContent.split(" ")[0] === "help") {
            output.innerHTML = `
                ...
                <p><code class="command">logout</code> --> logout/restart of Krypton</p>
